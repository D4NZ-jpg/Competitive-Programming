...
groups = [(800, 1100), (1200, 1300), (1400, 1500), (1600, 1800), (1900, 2000),
          (2100, 2200), (2300, 2300), (2400, 2500), (2600, 2900), (3000, 3500)]

colors = ["#cccccc", "#77ff77", "#84e0c2", "#b2b2ff", "#ff94ff",
          "#ffd194", "#ffc266", "#ff8484", "#ff4747", "#b21919"]

labels = ["800-1100", "1200-1300", "1400-1500", "1600-1800", "1900-2000",
          "2100-2200", "2300", "2400-2500", "2600-2900", "3000-3500"]
...
def stackedProblems(problems):
    ...
    ax.xaxis.set_major_formatter(ticker.FuncFormatter(
        format_date))  # Custom format for the tick labels
...
def updateAll():
    ...
    problems = [submission for submission in cf.getSubmissionList(
